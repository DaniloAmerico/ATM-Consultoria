...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mAppBarConfiguration = new AppBarConfiguration.Builder(
               R.id.nav_principal,R.id.nav_clientes, R.id.nav_contato,R.id.nav_servicos,R.id.nav_sobre
                )
    ...
    public void enviarEmail(){
        ...
        String celular = "tel:15991399858";
        String img = "https://www.melhoresdestinos.com.br/wp-content/uploads/2020/06/praias-brasil-sancho.jpg";
        String endereco = "https://www.google.com/maps/d/u/0/viewer?mid=1HVMZMZPkfAMtfKTh9uZlfRfg1kA&ll=41.12523919922502%2C-99.49562072753906&z=4";

        //Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse("tel:15991399858"));
